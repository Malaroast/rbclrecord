...
const COLUMN_CONFIG = {
  playerName: "Player",
  table: {
    batters: ["Player", "타석", "안타", "2루타", "3루타", "홈런", "볼넷", "삼진", "도루", "타점", "득점", "타율", "출루율", "장타율", "OPS", "wRC+", "소속 팀", "hWAR"],
    pitchers: ["Player", "출장 수", "선발등판 수", "이닝", "자책점", "탈삼진", "피안타", "피홈런", "볼넷", "승리", "패배", "세이브", "ERA", "WHIP", "pWAR", "소속 팀"]
  },
  detail: {
    batters: ["Player", "타석", "안타", "2루타", "3루타", "홈런", "볼넷", "삼진", "도루", "타점", "득점", "타율", "출루율", "장타율", "OPS", "wOBA", "wRC", "wRC+", "소속 팀", "wRAA", "hWAR", "FA 등급"],
    pitchers: ["Player", "출장 수", "선발등판 수", "이닝", "자책점", "탈삼진", "피안타", "피홈런", "볼넷", "승리", "패배", "세이브", "ERA", "WHIP", "ERA+", "pWAR", "소속 팀", "FIP", "FA 등급", "RAA"]
  }
};
